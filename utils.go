...
// //		switch boxer.Direction {
// //		case Left:
// //			boxer.Area[Max] = &Position{render.IdleBoxerForwardLength(), IdleBoxerWidth}
...
// //}
//
// //func RemoveBoxer(boxer game.Boxer, parts map[game.BodyPart][]game.Direction) {
// //	var (
// //		char     string
// //		charLen  int
...
// //			position = render.GetPosition(part, dir, boxer.Situation)
// //			charLen = utf8.RuneCountInString(render.GetBodyChar(part, dir, boxer.Situation, boxer.Direction))
// //			char = strings.Repeat(" ", charLen)
// //			// Check if it's right boxer change the direction to opposite
// //			if part != game.Head &&
// //				boxer.Direction == game.Right {
// //				position = render.GetPosition(part, dir.Opposite(), boxer.Situation)
// //			}
...
// //		boxer.boxerFrame(copyBoxer, render.AllBodyParts())
// //		frame(1)
// //		// Reform Idle
// //		//sBaseSit = Idle
